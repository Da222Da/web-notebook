...
function ot(e) {
  e.map.addEventListener("click", (t) => {
    ...
    t.button === n && t.target.contentEditable !== "true" && (T.moved = false, T.mousedown = true);
...
var ut = function(e) {
  ...
  e.appendChild(t), t.id = "input-box", t.textContent = n, t.contentEditable = "true", t.spellcheck = false;
...
var pt = function(e) {
  ...
  for (let c = 0; c < r.length; c++) {
    ...
    x.tagName === "svg" && x.remove(), l.appendChild(b), Re(this, b, v, l, p, true);
  }
  this.renderArrow(), this.renderSummary(), this.bus.fire("linkDiv");
};
var Re = function(e, t, n, o, s, i) {
...
function mt(e, t) {
  ...
  v.className = "context-menu", v.appendChild(h), v.hidden = true, e.container.append(v);
  let y = true;
  return e.container.oncontextmenu = function(b) {
    ...
    const x = b.target;
    if (le(x)) {
      x.parentElement.tagName === "ME-ROOT" ? y = true : y = false, y ? (d.className = "disabled", f.className = "disabled", g.className = "disabled", c.className = "disabled", l.className = "disabled", u.className = "disabled") : (d.className = "", f.className = "", g.className = "", c.className = "", l.className = "", u.className = ""), e.currentNodes || e.selectNode(x), v.hidden = false, T.mousedown && (T.mousedown = false), h.style.top = "", h.style.bottom = "", h.style.left = "", h.style.right = "";
    ...
    y || (e.insertSibling("after"), v.hidden = true);
  }, u.onclick = () => {
...
var At = (e, t, n) => t in e ? Lt(e, t, { enumerable: true, configurable: true, writable: true, value: n }) : e[t] = n;
var E = (e, t, n) => At(e, typeof t != "symbol" ? t + "" : t, n);
var jt = class {
  constructor() {
...
var H = Fe("addEventListener");
var L = Fe("removeEventListener");
var Q = (e) => {
  var t;
...
var Dt = () => matchMedia("(hover: none), (pointer: coarse)").matches;
...
var { abs: z, max: _e, min: Me, ceil: ke } = Math;
var Te = (e = []) => ({
  stored: e,
  selected: [],
  touched: [],
...
var qe = class extends jt {
  constructor(t) {
    var n, o, s, i, r;
    super(), E(this, "_options"), E(this, "_selection", Te()), E(this, "_area"), E(this, "_clippingElement"), E(this, "_targetElement"), E(this, "_targetBoundary"), E(this, "_targetBoundaryScrolled", true), E(this, "_targetRect"), E(this, "_selectables", []), E(this, "_latestElement"), E(this, "_areaLocation", { y1: 0, x2: 0, y2: 0, x1: 0 }), E(this, "_areaRect", new DOMRect()), E(this, "_singleClick", true), E(this, "_frame"), E(this, "_scrollAvailable", true), E(this, "_scrollingActive", false), E(this, "_scrollSpeed", { x: 0, y: 0 }), E(this, "_scrollDelta", { x: 0, y: 0 }), E(this, "disable", this._toggleStartEvents.bind(this, false)), E(this, "enable", this._toggleStartEvents), this._options = {
  ...
  _onTapStart(t, n = false) {
    ...
    if (this._targetBoundary = g.find((v) => p.includes(v)), !this._targetElement || !m || !this._targetBoundary || !n && this._emitEvent("beforestart", t) === false)
      return;
    this._areaLocation = { x1: o, y1: s, x2: 0, y2: 0 };
    const h = r.scrollingElement ?? r.body;
    this._scrollDelta = { x: h.scrollLeft, y: h.scrollTop }, this._singleClick = true, this.clearSelection(false, true), H(r, ["touchmove", "mousemove"], this._delayedTapMove, { passive: false }), H(r, ["mouseup", "touchcancel", "touchend"], this._onTapStop), H(r, "scroll", this._onScroll), u.deselectOnBlur && (this._targetBoundaryScrolled = false, H(this._targetBoundary, "scroll", this._onStartAreaScroll));
  }
  _onSingleTap(t) {
  ...
  _delayedTapMove(t) {
    ...
    if (
      ...
      if (L(o, ["mousemove", "touchmove"], this._delayedTapMove, { passive: false }), this._emitEvent("beforedrag", t) === false) {
        L(o, ["mouseup", "touchcancel", "touchend"], this._onTapStop);
        return;
      }
      H(o, ["mousemove", "touchmove"], this._onTapMove, { passive: false }), j(this._area, "display", "block"), F(n, o)[0].appendChild(this._clippingElement), this.resolveSelectables(), this._singleClick = false, this._targetRect = this._targetElement.getBoundingClientRect(), this._scrollAvailable = this._targetElement.scrollHeight !== this._targetElement.clientHeight || this._targetElement.scrollWidth !== this._targetElement.clientWidth, this._scrollAvailable && (H(this._targetElement, "wheel", this._manualScroll, { passive: false }), this._selectables = this._selectables.filter((u) => this._targetElement.contains(u))), this._setupSelectionArea(), this._emitEvent("start", t), this._onTapMove(t);
    }
  ...
  _onStartAreaScroll() {
    this._targetBoundaryScrolled = true, L(this._targetElement, "scroll", this._onStartAreaScroll);
  }
  _manualScroll(t) {
...
function Bt(e) {
  const t = e.mouseSelectionButton === 2 ? [2] : [0], n = new qe({
    ...
    !o.ctrlKey && !o.metaKey && (e.clearSelection(), n.clearSelection(true, true));
  }).on(
    "move",
    ({
      store: {
...
var Vt = function(e, t, n) {
  ...
  r.parentElement.insertAdjacentElement(We[e], c), this.linkDiv(c.offsetParent), n || this.editTopic(l.firstChild), this.selectNode(l.firstChild, true), this.bus.fire("operation", {
    name: "insertSibling",
    type: e,
    obj: i
  });
...
var bn = function(e) {
  e.nodeObj.parent && (this.tempDirection === null && (this.tempDirection = this.direction), this.isFocusMode || (this.nodeDataBackup = this.nodeData, this.isFocusMode = true), this.nodeData = e.nodeObj, this.initRight(), this.toCenter());
};
var xn = function() {
...
function $n() {
  ...
  for (let e = 0; e < this.arrows.length; e++) {
    ...
    try {
      Ge(this, C(t.from), C(t.to), t, true);
    } catch {
    }
  }
...
var oo = (e, t = false) => {
  ...
  N(c, {
    ...
    const m = p.cloneNode(true), { offsetLeft: h, offsetTop: v } = O(n, p.parentElement);
    m.setAttribute("x", `${h}`), m.setAttribute("y", `${v}`), r.appendChild(m);
  });
  const l = (a = n.querySelector(".lines")) == null ? void 0 : a.cloneNode(true);
  l && r.appendChild(l);
  const u = (f = n.querySelector(".topiclinks")) == null ? void 0 : f.cloneNode(true);
  u && r.appendChild(u);
  const d = (g = n.querySelector(".summary")) == null ? void 0 : g.cloneNode(true);
...
var co = async function(e = false, t) {
...
var lo = Object.freeze(Object.defineProperty({
  __proto__: null,
  exportPng: co,
  exportSvg: ro
}, Symbol.toStringTag, { value: "Module" }));
...
function A({
  ...
  y.className += " mind-elixir", y.innerHTML = "", this.mindElixirBox = y, this.disposable = [], this.before = a || {}, this.locale = n || "en", this.contextMenuOption = r, this.contextMenu = i === void 0 ? true : i, this.toolBar = c === void 0 ? true : c, this.keypress = l === void 0 ? true : l, this.mouseSelectionButton = u || 0, this.direction = typeof t == "number" ? t : 1, this.draggable = o === void 0 ? true : o, this.newTopicName = f || "new node", this.editable = s === void 0 ? true : s, this.allowUndo = g === void 0 ? false : g, this.currentNode = null, this.currentArrow = null, this.scaleVal = 1, this.tempDirection = null, this.generateMainBranch = p || uo, this.generateSubBranch = m || fo, this.overflowHidden = h || false, this.bus = st.create(), this.container = U.createElement("div"), this.selectionContainer = d || this.container, this.container.className = "map-container";
